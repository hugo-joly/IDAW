<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (isset($_POST['type']) && isset($_POST['nom'])) {
            $stmt = $pdo->prepare("INSERT INTO pers_aliments (id_user, type, nom, multiscore, calories, glucides, image) VALUES (:id_user, :type, :nom, :multiscore, :calories, :glucides, :image)");
